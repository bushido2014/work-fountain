...
$(function(){$("#my-menu").mmenu({extensions:["effect-menu-slide","pagedim-black"],navbar:{title:"Fountain"},offCanvas:{position:"right"},pageScroll:!0}),$("#my-menu").data("mmenu").bind("open:finish",function(){$(".hamburger").addClass("is-active")}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("header,section, footer").animated("fadeIn"),$(".headerContent__descr h1").animated("zoomIn"),$(".about .content .content__item:last-child").animated("fadeInRight","fadeOutDown"),$(".organic .content .content__item:last-child").animated("fadeInLeft","fadeOutDown"),$(".traditional .content .content__item:last-child").animated("fadeInRight","fadeOutDown"),$(".contentFarms").animated("fadeInRight","fadeOutDown"),$(".contentTea").animated("fadeInRight","fadeOutDown"),$(".form_contact").animated("fadeInUp","fadeOutDown");var n=$(".cd-top");$(window).scroll(function(){$(this).scrollTop()>300?n.addClass("cd-is-visible"):n.removeClass("cd-is-visible cd-fade-out"),$(this).scrollTop()>1200&&n.addClass("cd-fade-out")}),n.on("click",function(n){n.preventDefault(),$("body,html").animate({scrollTop:0},700)})});